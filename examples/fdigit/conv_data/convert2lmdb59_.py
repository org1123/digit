...
def main(args):
    ...
    val_list_path = 'E:/DCT/data/fcn/test.txt'
    ...
    pascal_context_to_lmdb('E:/DCT/data/fcn/image_jpgs_256',
                           'E:/DCT/data/fcn/mat_256/',
                           'E:/DCT/data/fcn/labels.txt',
                           'E:/DCT/data/fcn/labels1.txt',
                           '',
                           'E:/DCT/data/fcn/',
                           val_list=val_list
                           )
