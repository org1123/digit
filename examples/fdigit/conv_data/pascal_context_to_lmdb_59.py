...
def main(args):
    ...
    pascal_context_to_lmdb('D:/WeiShen/data/VOCdevkit/VOC2012/JPEGImages',
                           'D:/WeiShen/data/PASCAL-Context/trainval/',
                           'D:/WeiShen/data/PASCAL-Context/labels.txt',
                           'D:/WeiShen/data/PASCAL-Context/59_labels.txt',
                           '',
