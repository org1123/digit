...
def img_to_lmdb(dir_imgs,
    ...
    #for i in range(len(labels_list)+1):
      ...
      #print labels_list[i]
      #id1, names=labels_list[i]
      #labels_lut[i]=id1
    #labels_lut=labels_list
    print labels_lut
    ...
    paths_imgs = get_file_list(dir_imgs, [])
    paths_segm_labels = get_file_list(dir_segm_labels, [])
...
def main(args):
    ...
    #val_list_path = 'D:/WeiShen/data/PASCAL-Context/val_59.txt'
    #with open(val_list_path, 'r') as f:
        #val_list = f.readlines()
        #val_list = [l.translate(None, ''.join('\n')) for l in val_list if len(l) > 0]
    
    #nt, nv = \
    img_to_lmdb('E:/DCT/data/PASCAL-Context/val_jpg',
                'E:/DCT/data/PASCAL-Context/val_seg',
                'E:/DCT/data/PASCAL-Context/labels.txt',
                'E:/DCT/data/PASCAL-Context/59_labels1.txt',
                '',
                'E:/DCT/data/PASCAL-Context/',
                CAFFE_ROOT=CAFFE_ROOT,
                val_list=None,
                 )
